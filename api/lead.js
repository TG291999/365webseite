/* =========================================================================
   ...
   Environment Variables einzutragen, nicht im Code):
     ...
     LEAD_TO_EMAIL    Optional. Empfänger der Anfragen, Standard: tim@goebel-partner.de
                       (Übergangslösung: Mails an @365-grundbesitz.de-Adressen
                       bleiben beim empfangenden Server hängen, vermutlich wegen
                       des ungültigen DMARC-Eintrags dort. Sobald das bei all-inkl
                       behoben ist, hier zurück auf eine @365-grundbesitz.de-
                       Adresse umstellen.)
   ========================================================================= */

const ABSENDER = process.env.RESEND_FROM || 'Leonie Becker <becker@365-grundbesitz.de>';
const EMPFAENGER = process.env.LEAD_TO_EMAIL || 'tim@goebel-partner.de';
